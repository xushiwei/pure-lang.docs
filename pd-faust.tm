...
<\body>
  ...
  <hlink|Pure|http://pure-lang.googlecode.com/> programming language, so
  ...
  version (see the <hlink|Faust2|http://www.grame.fr/-tildeletz/faust-llvm.html>
  ...
  <\itemize>
    ...
    <hlink|Faust2|http://www.grame.fr/-tildeletz/faust-llvm.html>, you can
    also compile to an LLVM bitcode file instead; Pure has built-in support
    for loading these.) The Makefiles included in the pd-faust distribution
    show how to do this.
