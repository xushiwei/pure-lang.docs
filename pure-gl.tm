...
<\body>
  ...
  Get the latest source from <hlink|http://pure-lang.googlecode.com/files/pure-gl-0.8.tar.gz|http://pure-lang.googlecode.com/files/pure-gl-0.8.tar.gz>.
