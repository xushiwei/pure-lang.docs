...
<\body>
  ...
  Eddie Rucker \<less\>erucker at bmc.edu\<gtr\>
  ...
  download area at <hlink|http://pure-lang.googlecode.com|http://pure-lang.googlecode.com>.
  ...
  using LLVM 3.1 and Pure 0.56, please substitute your actual version numbers
  ...
  <hlink|http://pure-lang.googlecode.com/files/pure-0.56.tar.gz|http://pure-lang.googlecode.com/files/pure-0.56.tar.gz>

  <hlink|http://llvm.org/releases/3.1/llvm-3.1.src.tar.gz|http://llvm.org/releases/3.1/llvm-3.1.src.tar.gz>

  <hlink|http://llvm.org/releases/3.1/clang-3.1.src.tar.gz|http://llvm.org/releases/3.1/clang-3.1.src.tar.gz>

  <hlink|http://llvm.org/releases/3.1/dragonegg-3.1.src.tar.gz|http://llvm.org/releases/3.1/dragonegg-3.1.src.tar.gz>
  ...
  <\verbatim>
    ...
    $ tar xfvz clang-3.1.src.tar.gz && mv clang-3.1.src
    llvm-3.1.src/tools/clang
  ...
  as well as most of the LLVM toolchain. LLVM 3.1 is the latest stable
  release at the time of this writing. LLVM versions 2.5 thru 3.1 have all
  ...
  These can be downloaded from <hlink|http://pure-lang.googlecode.com|http://pure-lang.googlecode.com>.
  ...
  report at <hlink|http://code.google.com/p/pure-lang/issues/list|http://code.google.com/p/pure-lang/issues/list>.
  ...
  <hlink|http://code.google.com/p/pure-lang/source/browse/|http://code.google.com/p/pure-lang/source/browse/>
  ...
  described in the previous section, but note that
  <verbatim|--enable-release> and <verbatim|--enable-debug> will always
  overwrite the value of <verbatim|CXXFLAGS>. If this is a problem then it is
  best to just set up the required flags manually using the variables
  ...
  (<hlink|http://pure-lang.googlecode.com|http://pure-lang.googlecode.com>).
