...
<\body>
  ...
  <hlink|Pure|http://pure-lang.googlecode.com> interfaces to a selection of
  ...
  pure-stllib-0.4 requires at least Pure 0.50. The latest version of Pure is
  ...
  be downloaded from <hlink|http://pure-lang.googlecode.com/files/pure-stllib-0.4.tar.gz|http://pure-lang.googlecode.com/files/pure-stllib-0.4.tar.gz>.

  To install pure-stllib-0.4 (on Linux), extract the source code (e.g., tar
  -xzf pure-stllib-0.4.tar.gz), cd to the pure-stllib-0.4 directory, and run
