...
<\body>
  ...
  Get the latest source from <hlink|http://pure-lang.googlecode.com/files/pure-sockets-0.6.tar.gz|http://pure-lang.googlecode.com/files/pure-sockets-0.6.tar.gz>.
