...
<\body>
  ...
  Get the latest source from <hlink|http://pure-lang.googlecode.com/files/pure-glpk-0.2.tar.gz|http://pure-lang.googlecode.com/files/pure-glpk-0.2.tar.gz>.
  ...
  <verbatim|--enable-mysql> <verbatim|--with-gmp> <verbatim|--with-zlib>
  ...
  <\itemize>
    ...
    <item>ltdl dlopen library - must be enabled together with any of ODBC,
    zlib or MySQL.
  </itemize>
  ...
  <\quote-env>
    ...
    true: test the scaled problem false: test the unscaled problem
  </quote-env>
