...
<\body>
  ...
  You can get the latest source from <hlink|http://pure-lang.googlecode.com/files/pure-gtk-0.11.tar.gz|http://pure-lang.googlecode.com/files/pure-gtk-0.11.tar.gz>.

  For Windows users, a ready-made package in msi format is available from
  <hlink|http://pure-lang.googlecode.com/files/pure-gtk-0.11.msi|http://pure-lang.googlecode.com/files/pure-gtk-0.11.msi>.
