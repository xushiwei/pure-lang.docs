...
<\body>
  ...
  <label|module-stlmmap><label|module-stlhmap>Version 0.4, November 05, 2012

  Peter Summerland \<less\><hlink|p.summerland@gmail.com|mailto:p.summerland@gmail.com>\<gtr\>

  pure-stlmap is a <hlink|Pure|http://pure-lang.googlecode.com> interface
  to six associative containers provided by the <hlink|C++ Standard
