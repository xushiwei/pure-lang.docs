...
<\body>
  ...
  Get the latest source from <hlink|http://pure-lang.googlecode.com/files/pure-csv-1.5.tar.gz|http://pure-lang.googlecode.com/files/pure-csv-1.5.tar.gz>.
