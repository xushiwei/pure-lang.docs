...
<\body>
  ...
  <label|module-osc>Version 0.8, October 10, 2012
  ...
  <\itemize>
    <item>Get the latest source from <hlink|http://pure-lang.googlecode.com/files/pure-liblo-0.8.tar.gz|http://pure-lang.googlecode.com/files/pure-liblo-0.8.tar.gz>.
