...
<\body>
  ...
  <label|module-midifile>Version 0.5, October 10, 2012
  ...
  Get the latest source from <hlink|http://pure-lang.googlecode.com/files/pure-midi-0.5.tar.gz|http://pure-lang.googlecode.com/files/pure-midi-0.5.tar.gz>.
